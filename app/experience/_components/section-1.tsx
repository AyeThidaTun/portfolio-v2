...
export default function Section1() {
	return (
		<section className="p-10 max-w-6xl mx-auto py-10 lg:py-20">
			<div className="grid lg:grid-cols-2 gap-5 items-center">
				<div className="order-2 lg:order-1">
					<h2 className="text-3xl text-center lg:text-start font-bold mb-6 pt-5 lg:pt-0">
						Beyond the Code
					</h2>
				...
				<div className="flex justify-center order-1 lg:order-2">
					<div className="relative w-65 h-65 lg:w-75 lg:h-75">
