		...
		<section className="font-serif">
			...
			{projectDetailsData
				...
				.map((project) => (
					<div
						key={project.id}
						className="flex items-center justify-center px-5 lg:pt-20 lg:px-50 py-10 "
					>
						<div className="border border-gray-400 p-5 lg:p-10 rounded-md">
							...
							<section className="grid grid-cols-1 lg:grid-cols-3 gap-x-20 ">
								<div className="relative aspect-video w-full lg:w-87.5 col-span-1">
									<Image
										src={project.src}
										alt={project.title}
										fill
								...
								<div className="lg:col-span-2 space-y-5">
									<h2 className="text-lg font-semibold pt-5 lg:pt-0">
										{project.title}
									</h2>
